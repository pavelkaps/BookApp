...
public class MagazineFragment extends Fragment implements ItemObserver {
    ...
    private class RecyclerHolder extends RecyclerView.ViewHolder {
        ...
        public void bindGalleryItem(MagazineItem item) {
            mTitleTextView.setText(item.getTitle());
            mYearTextView.setText("№"+Integer.toString(item.Edition));
    ...
    private class RecyclerAdapter extends RecyclerView.Adapter<RecyclerHolder> {
        private List<MagazineItem> mItems;
        public RecyclerAdapter(List<MagazineItem> items) {
            mItems = items;
        }
        ...
        public void onBindViewHolder(RecyclerHolder photoHolder, int position) {
            MagazineItem galleryItem = mItems.get(position);
